...
const TIPS = [
  ...
  "Codemie Code auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Codemie Code auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Codemie Code uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Codemie Code from reading sensitive files",
  "Use {highlight}codemie run{/highlight} for non-interactive scripting",
  "Use {highlight}codemie --continue{/highlight} to resume the last session",
  "Use {highlight}codemie run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}codemie serve{/highlight} for headless API access to Codemie Code",
  "Use {highlight}codemie run --attach{/highlight} to connect to a running server",
  "Run {highlight}codemie upgrade{/highlight} to update to the latest version",
  "Run {highlight}codemie auth list{/highlight} to see all configured providers",
  "Run {highlight}codemie agent create{/highlight} for guided agent creation",
  "Run {highlight}codemie github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}codemie debug config{/highlight} to troubleshoot configuration",
